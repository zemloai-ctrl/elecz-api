...
## Tagline
Real-time electricity price signals for AI agents. 36 countries and regions, no authentication.

## Description
Elecz is the single source of truth for electricity prices, cheapest hours, and contract savings across Europe, Oceania, and North America. Built for AI agents, home automation, and EV charging.

Three MCP tools turn complex market data into actionable signals without any preprocessing:
- **spot_price** — real-time wholesale spot price in local currency (EUR, GBP, SEK, NOK, DKK, AUD, NZD, USD, CAD)
...
Data sources: ENTSO-E Transparency Platform (Europe, hourly), Octopus Agile API (GB, 30-min), AEMO (Australia, 5-min), EM6 (New Zealand, 30-min), CAISO OASIS (California, DAM daily), ERCOT CDR (Texas, 15-min), NYISO MIS (New York, 5-min), IESO (Ontario, 5-min).
...
## Features
- Real-time spot prices for 36 countries and regions across Europe, Oceania, and North America
...
- ENTSO-E + Octopus Agile + AEMO + EM6 + CAISO + ERCOT + NYISO + IESO data sources
...
## Tags
electricity, energy, spot-price, nordic, europe, north-america, finland, sweden, norway, denmark, germany, uk, australia, new-zealand, california, texas, new-york, ontario, home-automation, ev-charging, energy-optimization, price-signal, mcp, automation, smart-home
